...
NOTHING = BN3Chip("Nothing", "999", Code.Star, 0, BN3Element.Null, 100, Chip.NOTHING, "")
SENTINEL = BN3Chip("", "", Code.Star, 0, BN3Element.Null, 0, Chip.NOTHING, "")
...
def get_illegal_chip(name: str, code: Union[str, Code]) -> Optional[BN3Chip]:
